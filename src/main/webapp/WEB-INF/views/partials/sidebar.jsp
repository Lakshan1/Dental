...
<aside class="w-64 shrink-0 bg-white border-r border-gray-200 flex flex-col">
  ...
  <%-- ---- Navigation links ----
       The first link is styled as "active" (blue). The rest are grey and
       turn light-grey on hover. Each link = an icon + a label. --%>
  <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
    ...
    <%-- Appointments --%>
    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 hover:bg-gray-100">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 hover:bg-gray-100">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M9.75 3.104 8.7 5.7l-2.6 1.05 2.6 1.05L9.75 10.4l1.05-2.6 2.6-1.05-2.6-1.05L9.75 3.104ZM17 12l-.7 1.8-1.8.7 1.8.7.7 1.8.7-1.8 1.8-.7-1.8-.7L17 12Z"/>
      </svg>
      Services
    </a>
